...
}:
{
  ...
  dw-proton = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-+vNm1xJg40be5pYP9CbmkbkS4OwlQXdA6YHIrgWSRjA=";
    };
  };
  excalibur-wmi = {
    pname = "excalibur-wmi";
  ...
  seanime-bin-canary = {
    ...
    src = fetchurl {
      url = "https://seanime.app/api/updates/nightly/seanime-denshi-3.10.3-canary.1_Linux_x86_64.AppImage";
      sha256 = "sha256-mk0TnJaRPbmB3J+EyZwv9/Z7x9gECGzQ495EbdyAXhY=";
    };
  };
  victus-control = {
